...
function changeGoal(metric) {
    ...
    if (metric == 1)  {
        if (isNumber(document.getElementById('goalChangeInput1').value)) {
            if ((document.getElementById('goalChangeInput1').value >= 0) && (document.getElementById('goalChangeInput1').value <= 24)) {
    ...
    if (metric == 2)  {
        if (isNumber(document.getElementById('goalChangeInput2').value)) {
            if  ((document.getElementById('goalChangeInput2').value >= 1) && (document.getElementById('goalChangeInput2').value <= 5)) {
    ...
    if (metric == 3)  {
        if (isNumber(document.getElementById('goalChangeInput3').value)) {
            if ((isNumber(document.getElementById('goalChangeInput3').value >= 0)) && (isNumber(document.getElementById('goalChangeInput3').value <= 24))) {
    ...
    if (metric == 4)  {
        if (isNumber(document.getElementById('goalChangeInput4').value)) {
            if ((isNumber(document.getElementById('goalChangeInput4').value >= 0)) && (isNumber(document.getElementById('goalChangeInput4').value <= 20))) {
    ...
    if (metric == 5)  {
        if (isNumber(document.getElementById('goalChangeInput5').value)) {
            if ((isNumber(document.getElementById('goalChangeInput5').value >= 0)) && (isNumber(document.getElementById('goalChangeInput5').value <= 300000))) {
    ...
    if (metric == 6) {
        if (isNumber(document.getElementById('goalChangeInput6').value)) {
            if ((isNumber(document.getElementById('goalChangeInput6').value >= 0)) && (isNumber(document.getElementById('goalChangeInput6').value <= 24))) {
